...
// Mudar Aqui o e-mail
$email_envio = "felipedegenerportella@yahoo.com"; // E-mail do site (ex: contato@seusite.com)
$email_pass = "123456"; // Senha do e-mail

$site_name = "DarWeb"; // Nome do Site
$site_url = "www.darweb.com.br"; // URL do Site
  ...
  <html>
    ...
    <body>
      ...
      <div class="form-content" id="form-erro">
        ...
        <p>Você pode tentar novamente ou enviar direto para felipedegenerportella@bikcraft.com<?php echo $email_envio; ?></p>
      </div>
    </body>
  </html>
